...
const Auction_contract = '0xA8db0B59d392b054b8C733fEECDFBf59a495bE1f';
...
//      103: "http://3.112.217.80:22000",
  ...
  public testPltSendTransaction = async () => {
    ...
    // value
    const _plt_value = PLT_transfer_amount;
  ...
  public testNFTSendTransaction = async () => {
    ...
    // token id
    const _nft_token_id = NFT_token_id_for_transfer;
  ...
  public testNFTApproveTransaction = async () => {
    ...
    // token id
    const _nft_token_id = NFT_token_id_for_approve;
    const nft_value_id = _nft_token_id;
  ...
  public testSellRequestTransaction = async () => {
    ...
    // sell NFT token id
    const sellTokenId = NFT_token_id_for_sell;
  ...
  public testPLTApproveTransaction = async () => {
    ...
    // price
    const _plt_price = PLT_price_for_approve;
    const price = sanitizeHex(convertStringToHex(_plt_price * Math.pow(10,18)));
...
//          connector,
  ...
  public testAuctionBidRequest2Transaction = async () => {
    const { address/*, chainId*/ } = this.state;
  ...
  public testAuctionBidRequest3Transaction = async () => {
    const { address/*, chainId*/ } = this.state;
  ...
  public testAuctionFinishTransaction = async () => {
    const { address/*, chainId*/ } = this.state;
    ...
    const web3 = new Web3(Web3.givenProvider);
    const auction = new web3.eth.Contract(AuctionABI as AbiItem[], to);
    const data = auction.methods.finishAuction(owner, sellToken, sellTokenIds, buyToken).encodeABI({
      nonce: parseInt(nonce, 16),
      from,
      to,
      value,
              ...
              <SBalances>
                ...
                <Column center>
                  <STestButtonContainer>
                    ...
                    <STestButton left onClick={this.testAuctionBidRequest2Transaction}>
                      {"bid_request 2"}
                    </STestButton>
